...
public class BusquedaBinaria extends JLayeredPane{
	public static JLabel lblBuscar = new JLabel();
	 ...
	 public static void ejemploMejorCasoAction() {
		 ...
		 crearGrafico();
		 Princ.txtMensaje.setText("Ejemplo mejor caso busqueda binaria en "+cantListas+" listas distintas");
	 }
	 ...
	 public void ejemploEncontrado() {
		 ...
		 for(int i = 0; i < cantListas; i++) {
			 ...
			 tamano.add(tam);
			 long inicio = System.currentTimeMillis();
		   	 Busqueda.binarySearch(lRan, 1, 0, lRan.size()-1);
		 ...
		 crearGrafico();
		 Princ.txtMensaje.setText("Ejemplo numero encontrado busqueda binaria en "+cantListas+" listas de tamaño 2 elevado a 'n'");
	 ...
	 public void ejemploNoEncontrado() {
		 ...
		 crearGrafico();
		 Princ.txtMensaje.setText("Ejemplo numero NO encontrado busqueda binaria en "+cantListas+" listas de tamaño 2 elevado a 'n'");
	 }
