	...
	public static JLabel lblBuscar = new JLabel();
	 ...
	 public void initComponents() {
		 txtNum.setBounds(10, 26, 46, 35);
		   ...
		   lblBuscar.setIcon(new ImageIcon(BusquedaSecuencial.class.getResource("/Image/icons8_search_30px.png")));
		   ...
		   lblBuscarRandom.setIcon(new ImageIcon(BusquedaSecuencial.class.getResource("/Image/icons8_search_30px.png")));
		   ...
		   lblMejorCasoBoton.setIcon(new ImageIcon(BusquedaSecuencial.class.getResource("/Image/icons8_facebook_like_30px_2.png")));
		   ...
		   lblEncontradoBoton.setIcon(new ImageIcon(BusquedaSecuencial.class.getResource("/Image/icons8_happy_30px.png")));
		   ...
		   lblNoEncontradoBoton.setIcon(new ImageIcon(BusquedaSecuencial.class.getResource("/Image/icons8_sad_30px_2.png")));
